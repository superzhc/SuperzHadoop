package com.github.superzhc.demo.es;

import com.github.superzhc.es.*;
import com.github.superzhc.es.util.IndexUtils;
import com.github.superzhc.format.JSONFormat;

import com.github.superzhc.es.search.ESIndexsSearch;
...
public class ESDemo
{
    ...
    public static void main(String[] args) {
        try (ESClient client = ESClient.create(PropertiesUtils.get("es.host"), PropertiesUtils.getInt("es.port"))) {
