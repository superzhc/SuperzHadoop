                ...
                .click(function (e) {
                    ...
                    function appendItem(colsItem, openData) {
                        ...
                        if (colsItem.templet) {
                            ...
                            // 2020年9月7日 superz modify fix bug
                            // html.push(colsItem.templet(openData));
                            html.push("<span class='opTable-item-title'>" + colsItem["title"] + "：</span>");
                            var str = typeof colsItem.templet === 'function'
                                ? colsItem.templet(openData)
                                : laytpl($(colsItem.templet).html() || String(colsItem.templet)).render(openData);
                            html.push("<span class='opTable-exp-value' >" + str + "</span>");
                            html.push("</div>")
                            //  2、可下拉选择类型
