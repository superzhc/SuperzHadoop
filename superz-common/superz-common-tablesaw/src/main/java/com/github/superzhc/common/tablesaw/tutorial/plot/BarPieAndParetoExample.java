package com.github.superzhc.common.tablesaw.tutorial.plot;
...
public class BarPieAndParetoExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Table tornadoes = Table.read().csv("./superz-common/superz-common-tablesaw/data/tornadoes_1950-2014.csv");
