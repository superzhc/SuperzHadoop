...
| **参数名称**                  | **含义**                                                   | **默认值**           | 备注 |
| ----------------------------- | ---------------------------------------------------------- | -------------------- | ------------------------------------------------------------ |
| `-Xms`                        | 初始堆大小                                                 | 物理内存的1/64(<1GB) | 默认(MinHeapFreeRatio参数可以调整)空余堆内存大于40%时，JVM就会增大堆直到-Xmx的最大限制. |
| `-Xmx`                        | 最大堆大小                                                 | 物理内存的1/4(<1GB)  | 默认(MaxHeapFreeRatio参数可以调整)空余堆内存小于70%时，JVM会减少堆直到 -Xms的最小限制 |
