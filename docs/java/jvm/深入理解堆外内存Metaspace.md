...
![Metadata lifecycle - Allocation](images/metaspace-lifecycle-allocation.png)
...
![Metadata lifecycle - Deallocation](images/metaspace-lifecycle-deallocation.png)
...
![alt text](images/metaspace-vsnode-multiple-loaders-one-dies.png)

这些 chunks 会被复用：如果其他的类加载器加载新的类，它可能就会得到一个空闲列表中的 chunk，而不是去 Node 中申请一个新的 chunk。

![alt text](images/metaspace-vsnode-multiple-loaders-chunk-reused.png)
...
![alt text](images/metaspace-metachunk.png)
...
![alt text](images/metaspace-classloadermetaspace.png)
...
![alt text](images/metaspace-vsnode-purged.png)
...
![alt text](images/metaspace-uncompressed-class-ptr.png)

当使用了 compressed class pointers，这个引用是 32 位的值，为了找到真正的 64 位地址，需要加上一个 base 值：

![alt text](images/metaspace-compressed-class-ptr.png)
...
![alt text](images/metaspace-classspace-duality.png)
...
![MaxMetaspaceSize and CompressedClassSpaceSize](images/metaspace-sizing-params.png)
...
![How much space does a Java class need?](images/metaspace-class-metadata.png)
