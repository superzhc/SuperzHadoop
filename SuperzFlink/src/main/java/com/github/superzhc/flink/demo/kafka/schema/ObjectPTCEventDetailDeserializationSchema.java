package com.github.superzhc.flink.demo.kafka.schema;
...
public class ObjectPTCEventDetailDeserializationSchema implements KafkaDeserializationSchema<EventDto<List<ObjectPTCEventDetailDTO>>> {
