...
public class DouBanBookDetail implements PageProcessor {
    ...
    public void process(Page page) {
        ...
        String pub = html.xpath("//*[@id=\"info\"]/text()[2]").get();
        String name2 = html.xpath("//*[@id=\"info\"]/text()[3]").get();
        String pubYear = html.xpath("//*[@id=\"info\"]/text()[4]").get();
    ...
    public static void main(String[] args) {
        Spider.create(new DouBanBookDetail())
                .addUrl("https://book.douban.com/subject/1084336/")
                .run();
    }
}
