package com.github.superzhc.translate.utils;
...
public class UUIDV5 {
    public static UUID fromUTF8(String name) {
        ...
        return from(name,"UTF-8");
    }

    public static UUID from(String name,String charset){
        return fromBytes(name.getBytes(Charset.forName(charset)));
    }
