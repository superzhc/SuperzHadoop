...
public class IndexConstant {
    ...
    public static final String INDEX_BASIC_DATE = "index_basic_date";
    public static final String INDEX_PUBLISH_DATE = "index_publish_date";
    public static final String INDEX_ADJUST_FREQUENCY = "index_adjust_frequency";
    public static final String INDEX_SAMPLE = "index_sample";
