package com.github.superzhc.hadoop.flink2.streaming.connector.redis;
...
import com.github.superzhc.hadoop.flink2.streaming.connector.redis.container.RedisCommandsContainer;
import com.github.superzhc.hadoop.flink2.streaming.connector.redis.container.RedisCommandsContainerBuilder;
...
import com.github.superzhc.hadoop.flink2.streaming.connector.redis.mapper.RedisDataType;
...
public class RedisSink<IN> extends RichSinkFunction<IN> {
    ...
    public void invoke(IN input, Context context) throws Exception {
        ...
        switch (redisCommand) {
            ...
            case SETEX:
                ...
                break;
            case APPEND:
                this.redisCommandsContainer.append(key, value);
                break;
            case PFADD:
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<Map<String, Object>> ds2 = ds.map(new MapFunction<String, Map<String, Object>>() {
            @Override
            public Map<String, Object> map(String value) throws Exception {
                return JsonUtils.map(value);
            }
        });
        ...
        RedisSink<Map<String, Object>> sink = new RedisSink<>(
                flinkJedisPoolConfig,
                new RedisMapper<Map<String, Object>>() {
                    @Override
                    public RedisCommandDescription getCommandDescription() {
                    ...
                    public String getKeyFromData(Map<String, Object> data) {
                        return String.valueOf(data.get("id_card"));
                    }
