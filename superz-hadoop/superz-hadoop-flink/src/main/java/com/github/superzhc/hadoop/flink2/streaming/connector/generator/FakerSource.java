package com.github.superzhc.hadoop.flink2.streaming.connector.generator;
 ...
 */
public class FakerSource extends RichSourceFunction<String> /*implements CheckpointedFunction*/ {
    ...
    public FakerSource(Map<String, String> expressions) {
        this(expressions, DEFAULT_LOCALE);
    }

    public FakerSource(Map<String, String> expressions, String locale) {
        this(expressions, locale, DEFAULT_ROWS_PER_SECOND);
    }

    public FakerSource(Map<String, String> expressions, Long rowsPerSecond) {
        this(expressions, DEFAULT_LOCALE, rowsPerSecond);
    }

    public FakerSource(Map<String, String> expressions, String locale, Long rowsPerSecond) {
        this(expressions, locale, rowsPerSecond, DEFAULT_NUMBER_OF_ROWS);
    }

    public FakerSource(Map<String, String> expressions, String locale, Long rowsPerSecond, Long numberOfRows) {
        this.locale = locale;
